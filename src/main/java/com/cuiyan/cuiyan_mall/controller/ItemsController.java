...
public class ItemsController {
    ...
    public ResultMessage findByName(@RequestBody Items items) {
        ...
        List<Items> items1 = mapper.selectList(queryWrapper);
        if (items1!=null){
            resultMessage.success("200","查询成功",items1);
        } else {
